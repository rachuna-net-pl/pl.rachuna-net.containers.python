...
chmod 700 /home/python/.ssh
echo "$GITLAB_SSH_KEY" > /home/python/.ssh/id_rsa
chmod 600 /home/python/.ssh/id_rsa

echo "Host gitlab.com IdentityFile /home/python/.ssh/id_rsa StrictHostKeyChecking no" > /home/python/.ssh/config
